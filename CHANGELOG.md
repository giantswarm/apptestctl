...
- Remove checks for PodSecurityPolicy resources
...
- Add `ScaledObjects` to crds.go file.
...
[Unreleased]: https://github.com/giantswarm/apptestctl/compare/v0.23.2...HEAD
[0.23.2]: https://github.com/giantswarm/apptestctl/compare/v0.23.1...v0.23.2
[0.23.1]: https://github.com/giantswarm/apptestctl/compare/v0.23.0...v0.23.1
